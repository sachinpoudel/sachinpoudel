...
export default function HomePage() {
  ...
  return (
    <div className="max-w-2xl mx-auto px-6 py-16 bg-white/40 dark:bg-gray-900/40 backdrop-blur-sm min-h-screen shadow-2xl border-x border-gray-200/40 dark:border-gray-700/40">
      ...
      <div id="top" className="flex justify-between items-center mb-18">
        <div>
      ...
      <div className="mb-20 p-8 bg-gradient-to-br from-white/60 to-gray-50/60 dark:from-gray-800/40 dark:to-gray-900/40 rounded-2xl border border-gray-200/40 dark:border-gray-700/40 shadow-lg backdrop-blur-sm">
